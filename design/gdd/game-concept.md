...
> 你是孤山剑派的最后弟子。一夜之间师门尽灭，你披白衣下山，沿着三个仇人的踪迹一路追查 —— 江南烟雨、塞北风雪、戈壁孤城。但越追越发现，这不是一桩简单的师门血案：有人在用整个江湖做局，而你的师门，不过是开局的一颗弃子。
...
- **Onboarding curve**：起点章节（孤山脚下，约 1 小时）作为完整教学，包含一场战斗 + 一段对话 + 一个支线 + 第一次心境选择。玩家在结束时已学会全部基础系统
...
**核心假设**：「Burst + Read 回合制武学战斗 + 武学残片获取 + 朦胧化 UI + 一位女主彗星模型陪伴」的组合，能在 3-4 小时内让玩家**爱上《孤山遗剑》的世界与角色**。

**Required for MVP** (3-4 小时可玩):
1. **起点孤山章节 + 江南章前半** —— 完整教学 + 第一段冒险 + 第一个 boss 战
2. **2 套武学**（孤山剑法起手 + 1 套来自击败第 1 个仇人）+ 2 心法 + 残片机制
