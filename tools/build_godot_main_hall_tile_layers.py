...
MAP_ROOT = GODOT_ROOT / "assets/maps/main_hall/maps"
OUTPUT_SCENE = "res://scenes/main_hall/MainHallTileLayers.tscn"
TILESET_PATH = "res://assets/maps/main_hall/tilesets/main_hall_ground_tiles.tres"

MAPS = {
    "Day": MAP_ROOT / "main_hall_day.tmx",
    "Night": MAP_ROOT / "main_hall_night.tmx",
}
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        script_path = Path(tmp) / "build_main_hall_tile_layers.gd"
