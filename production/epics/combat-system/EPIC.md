...
回合制战斗是《风止》的核心玩法闭环，负责实现战棋式多人战斗、Burst+Read 回合流程、刚柔巧克制、行动提交、速度演出排序、伤害/破绽/内息结算和战斗结束事件。它按照 `Core/Combat/` 模块边界组织战斗阶段状态机，读取角色属性、武学招式、敌方 AI、物品和顿悟相关输入，并通过 EventBus 向 UI、音频、心境、顿悟和存档等系统广播战斗结果；战斗系统不持有 UI 表现和叙事内容本身。
...
| 回合开始、意图公开、玩家决策、同时结算、回合结束的完整流程 | ADR-0008 ✅ / ⚠️ 细节需 stories 验证 |
...
- 回合流程、行动提交、冷却、速度排序、克制、破绽、内息、伤害和战斗结束判定均有自动化测试覆盖
