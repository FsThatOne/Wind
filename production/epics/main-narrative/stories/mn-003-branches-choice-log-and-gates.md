...
> **Type**: Logic
> **Requirement**: `TR-main-narrative-003`

## Acceptance Criteria

- [x] AC-3: 分支节点选择后正确记录到 choice_log。
- [x] Formula: 已完成分支数 >= gate.required_branches 时可通过章节门。
- [x] AC-20/21: 软前置满足解锁额外内容，不满足不阻塞主线。
...
**Story Type**: Logic
**Required evidence**:
- `tests/unit/narrative/narrative_branch_gate_test.cs`

**Status**: [x] Created and passing

## Dependencies

- Depends on: mn-001, mn-002
- Unlocks: mn-004, mn-008
